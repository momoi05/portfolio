    ...
    <div className="manga-page live-inking"> {/* Ajout de la texture papier globale */}
        ...
        <div className="manga-panel live-border info-vibe">
          ...
          <div className="panel-body">
            <p>Passionnée par l’informatique, un domaine que j’ai découvert d’abord à travers les jeux vidéo, puis approfondi lors de mes premières expériences en stage.
                ...
                Cette curiosité me pousse à apprendre en continu, à  expérimenter par moi-même et à sortir de ma zone de confort pour élargir mes compétences.</p>
      ...
      <div className="manga-grid-bottom">
        {[
          ...
          { date: "2022", text: "<strong>Stage Seconde</strong><br/>Informatique<br/>J'ai réalisé un premier stage en seconde à Active Developpement, une entreprise qui crée des sites web. Ce qui m'a permis de découvrir le monde du travail et de la programmation.<br/>Lors de ce stage j'ai réalisé mon rapport de stage en html css", type: "boy" },
          { date: "2021", text: "<strong>Stage Troisième</strong><br/>Informatique<br/>Mon stage de troisième à Kéolis Lyon, une entreprise qui gère le réseau des transport urbain m'a permis de découvrir différentes infrastrucure informatique. J'ai observer la maintenance des outils informatiques utiliser. Cela m'as pas la suite donnée envie dans conanaitre plus ce qui m'as ammené à mes experiences suivantes", type: "girl" }
        ].map((item, index) => (
